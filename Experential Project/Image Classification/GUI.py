...
# Here, we will build a graphical user interface for our image classifier.
# We will build this GUI using Tkinter python library. To install Tkinker: pip install tkintertable
